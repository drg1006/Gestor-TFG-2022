...
\imagenflotante{SinUsuarioLogin}{Intento de inicio de sesión sin rellenar el usuario}{0.9}
\imagenflotante{SinpasswordLogin}{Intento de inicio de sesión sin rellenar la contraseña}{0.9}
...
\begin{itemize}
	...
	\imagenflotante{LoginError_Permisos}{Inicio de sesión - Error de permisos}{0.9}
\end{itemize}

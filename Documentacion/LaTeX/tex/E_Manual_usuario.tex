...
\imagenflotante{parametros}{Selección de parámetros de creación de informe.}{0.9}
...
\imagenflotante{camposInforme}{Avisos para el usuario de los campos a introducir}{0.9}
...
\imagenflotante{informe_excel}{Informe del área de Lenguajes y Sistemas Informáticos}{0.7}

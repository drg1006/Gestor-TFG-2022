...
\imagenflotante{actores}{Actores de la aplicación frente a las funcionalidades, en negro en la versión anterior y el rojo las añadidas.}{1.3}
...
}
{
	...
	& 3    & Indicar el nombre que le queremos dar al informe\\\hline
	Postcondiciones                        & \multicolumn{2}{p{10.25cm}}{Indicar la ruta en la que descargar el informe generado} \\\hline
	Excepciones                        & \multicolumn{2}{p{10.25cm}}{No se indica una ruta correcta de descarga} \\\hline

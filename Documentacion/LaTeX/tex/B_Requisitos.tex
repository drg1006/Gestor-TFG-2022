...
}
{
	...
	Postcondiciones                        & \multicolumn{2}{p{10.25cm}}{Ser aprobado por un administrador.} \\\hline
	Excepciones                        & \multicolumn{2}{p{10.25cm}}{Ninguna }\\\hline
	Frecuencia                             & Media \\\hline
	Importancia                            & Alta \\\hline
	Urgencia                               & Alta \\
...
\tablaSmallSinColores{Caso de uso 6: Generar un informe.}{p{3cm} p{.75cm} p{9cm}}{tablaCU6}{
	\multicolumn{3}{p{10.25cm}}{Caso de uso 6: Generar un informe.} \\
}
{
	Descripción                            & \multicolumn{2}{p{10.25cm}}{Permitir a un administrador modificar el estado de un TFG con estado \emph{Pendiente} } \\\hline

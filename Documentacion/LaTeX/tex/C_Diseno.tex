...
\imagenflotante{Diagrama_clase_Persistencia}{Diagrama de clase - Persistencia}{1}
...
\begin{itemize}
	...
	\imagenflotante{Diagrama_clase_View}{Diagrama de clase - Vistas}{1}
	...
	\imagenflotante{Diagrama_clase_Components}{Diagrama de clase - Componentes}{1}
	...
	\imagenflotante{Diagrama_clase_util}{Diagrama de clase - Util}{1}
	...
	\imagenflotante{Diagrama_clase_Entity}{Diagrama de clase - Entidades}{1}
	...
	\imagenflotante{Diagrama_clase_Security}{Diagrama de clase - Autenticación con moodle}{1}
	...
	\imagenflotante{Diagrama_clase_WebService}{Diagrama de clase -Servicios web}{1}
\end{itemize}
...
\imagenflotante{Diagrama_clase_Test}{Diagrama de clase - Tests}{1}
...
\imagenflotante{Singleton_diagrama}{Diagrama uml de la estructura del Singleton~\cite{imagen_Singleton}}{1}
...
\imagenflotante{Fachada_diagrama}{Diagrama uml de la estructura de la Fachada~\cite{imagen_Fachada}}{1}
...
\begin{itemize}
	...
	\imagenflotante{Actualización_ficheros}{Actualización de ficheros csv y xls en la aplicación}{1.2} 

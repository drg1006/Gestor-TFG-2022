...
\item HtmlUnit~\cite{HTMLUNIT} es un "navegador sin GUI para programas Java". Modela documentos HTML y proporciona una API que le permite invocar páginas, completar formularios, hacer clic en enlaces, etc... tal como lo haces en tu navegador. 

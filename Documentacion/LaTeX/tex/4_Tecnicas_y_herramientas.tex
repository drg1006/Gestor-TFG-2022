...
LucidChart ~\cite{LucidChart} es una aplicación de diagramación inteligente que reúne a los equipos para que tomen mejores decisiones y construyan el futuro. Ha sido utilizada para realizar los diagramas de flujo del Anexo.

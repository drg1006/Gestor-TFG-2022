...
\begin{itemize}
	...
	\end{itemize}
\end{itemize}
\imagenflotante{P02Activos}{Comprobación pantalla activos.}{0.9}

\imagenflotante{P02GraficaRaul}{Comprobación gráfica de proyectos dirigidos de Raúl.}{0.9}
\imagenflotante{P02GraficaAD}{Comprobación gráfica de los proyectos de Lenguajes.}{0.9}

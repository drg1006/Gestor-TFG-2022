...
\subsection{Login}
Validación del correcto acceso a las funcionalidades de los distintos roles que un usuario puede tener.
----

\subsection{Histórico del profesorado}

Para realizar estas pruebas o validaciones de la aplicación se subirán, mediante la opción de actualizar ficheros, nuevos archivos con menos proyectos para comprobar que las estadísticas se realizan de forma correcta.
--------
...
De igual manera que en la sección anterior se ha subido otro archivo para comprobar que los datos que se generan en el informe son correctos:
---------

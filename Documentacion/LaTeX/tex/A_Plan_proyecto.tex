...
\begin{itemize}
	...
	\item Se ha arreglado la pantalla de históricos que no recogía bien la información de la base de datos en la versión anterior.
	\item Se ha terminado de arreglar los \emph{bugs} encontrados al crear un informe.
	\item Se ha mejorado la eficiencia del código en ciertas pestañas.
...
En esta sección se mostrará una ideal inicial de como iba a ser el reparto de horas inicial y cual fue el real de las diferentes tareas durante el desarrollo del TFG. La tabla \ref{horas} muestra una predicción de la división del proyecto. Ver tabla \ref{horas}.
...
Se detallaran las licencias \emph{Software} de cada dependencia que se ha utilizado en el proyecto. En el proyecto se ha usado la misma licencia MIT que se utilizaba en la versión anterior del proyecto que permite la libre distribución del \emph{software}. Ver tabla \ref{Dependencias del proyecto}

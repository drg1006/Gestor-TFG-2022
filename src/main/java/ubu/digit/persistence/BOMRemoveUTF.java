...
/**
 * Clase que se encarga de eliminar los caracteres unicode BOM (Byte Order Mark)
 * de los ficheros.
 */
public class BOMRemoveUTF {
    ...
    /***
     * Elimina el caracter unicode BOM (Byte Order Mark) de los archivos del
     * directorio.
     * 
    ...
    /**
     * Elimina el caracter unicode character BOM (Byte Order Mark) del comienzo del
     * fichero.
     * 
     * @param buffer
     * @throws FileNotFoundException

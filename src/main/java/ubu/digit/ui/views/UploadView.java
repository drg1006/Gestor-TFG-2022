...
public class UploadView extends VerticalLayout implements BeforeEnterObserver {
    ...
    private void ConfigureLogin() {
        ...
        // Al finalizar la actualización del fichero se cambia el modelo de datos al
        // correspondiente al fichero subido.
        ...
        // Cuando se rechaza el fichero debido a: setMaxFileSize, setMaxFiles,
    ...
    /**
     * Función que muestra un mensaje cuando el fichero se ha actualizado
     * correctamente.
     * 
     * @param text
    ...
    /**
     * Comprueba que el nombre del fichero csv corresponda con alguno de los
     * siguientes:
    ...
    private Boolean checkNameFile(StartedEvent event) {
        if (event.getFileName().endsWith(".csv") && event.getFileName().equals("N1_Documento.csv") == false
                && event.getFileName().equals("N1_Tribunal.csv") == false
                && event.getFileName().equals("N1_Norma.csv") == false
                && event.getFileName().equals("N2_Alumno.csv") == false
                && event.getFileName().equals("N2_Proyecto.csv") == false
     ...
     * Si el fichero es de tipo xls se sobreescribe el nombre por
     * "BaseDeDatosTFGTFM.xls".
     * 
     * @param event

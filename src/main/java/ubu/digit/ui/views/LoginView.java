...
public class LoginView extends VerticalLayout{
	...
	/**
	 * Comprueba si el usuario y la contraseña introducidos en el login existe en moodle de UbuVirtual, si tiene
	 * la asignatura correspondiente al TFG y si tiene permisos de actualización (update) en dicha asignatura.
	 * 
	 * Si todos estos casos se cumplen entonces se retorna true, con lo que se autentificará el usuario y se permitirá 
	 ...
	 * @return boolean 
	 * 			True, si el usuario y la contraseña están autentificados, posee la asignatura de TFG y tiene permisos de actualización
	...
	public Boolean CheckData(String username, String password) {
		try {
			...
			createErrorLogin("Usuario/contraseña inválidos", "Verifique su usuario y contraseña y vuelva a intentarlo.");

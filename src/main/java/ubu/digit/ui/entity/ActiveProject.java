...
public class ActiveProject extends Projects implements Serializable {
     ...
     */
    public ActiveProject(String title, String description, String tutors, String students, LocalDate dateAssignment,
            String status) {
        this.title = title;
    ...
    /**
     * Constructior vacio, se utiliza para crear un proyecto sin tener asignaciones
     * de manera inicial.
     */

...
public class NavigationBar extends HorizontalLayout {
    ...
    private void initComponents() {
        ...
        // Layouts para meter los botones de inicio/cierre sesion y toda la otra barra
        // de navegacion
        ...
        buttonMetrics.addClickListener(e -> UI.getCurrent().getPage().executeJavaScript(
                "window.open(\"https://sonarcloud.io/organizations/drg1006/projects/\", \"_blank\");"));
        ...
        // Comprobamos si se ha iniciado sesion para ver cual de los dos botones hay que
        // poner
        ...
        if (UI.getCurrent().getSession().getAttribute("update") != null) {
            ...
            if (UI.getCurrent().getSession().getAttribute("reports").equals("true")) {
                // ROL DE PROFESOR
                layout2.addAndExpand(buttonInfo, buttonActive, buttonHistoric, buttonReport, buttonUpload,
                        buttonMetrics);
            }
        } else {
            // ROL ALUMNO
